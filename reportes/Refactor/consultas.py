...
#Semanales
flujo_semanal_pon = [truncate_promedio_semanal_pon,truncate_picos_semanal_pon,truncate_reporte_semanal_pon,truncate_respaldo_semanal_pon,insert_promedio_semanal_pon,insert_picos_semanal_pon,insert_reporte_semanal_pon,insert_respaldo_semanal_pon,truncate_picos_diarios_semanal_pon]
flujo_semanal_ont = [truncate_promedio_semanal_ont,truncate_picos_semanal_ont,truncate_reporte_semanal_ont,truncate_respaldo_semanal_ont,insert_promedio_semanal_ont,insert_picos_semanal_ont,insert_reporte_semanal_ont,insert_respaldo_semanal_ont,truncate_picos_diarios_semanal_ont]
flujo_semanal = [flujo_semanal_pon,flujo_semanal_ont]
#Mensuales
flujo_mensual_pon = [truncate_promedio_mensual_pon,truncate_picos_mensual_pon,truncate_reporte_mensual_pon,truncate_respaldo_mensual_pon,insert_promedio_mensual_pon,insert_picos_mensual_pon,insert_reporte_mensual_pon,insert_respaldo_mensual_pon,truncate_picos_diarios_mensual_pon]
flujo_mensual_ont = [truncate_promedio_mensual_ont,truncate_picos_mensual_ont,truncate_reporte_mensual_ont,truncate_respaldo_mensual_ont,insert_promedio_mensual_ont,insert_picos_mensual_ont,insert_reporte_mensual_ont,insert_respaldo_mensual_ont,truncate_picos_diarios_mensual_ont]
