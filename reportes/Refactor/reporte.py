...
def apend_data_PON(workbook,hojas,periodo):
    ...
    for dato in resultado:
        ...
        elif ((direccion == "TX") and (nodo in c300_19p) and (puerto not in puertos_uplink_omitidos_z_19)) or (direccion == "TX" and puerto not in puertos_uplink_omitidos_z):
        ...
        elif ((direccion == "RX") and (nodo in c300_19p) and (puerto not in puertos_uplink_omitidos_z_19)) or (direccion == "RX" and puerto not in puertos_uplink_omitidos_z):
