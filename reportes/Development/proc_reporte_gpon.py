...
#camino para producción
#path ="./gpon/"
#camino para pruebas
path = ""
nombre_archivo = "PLN245_procesado.TXT"
...
with open(path_archivo,"r") as archivo:
    #archivo parseado
    with open("./PLN245_parseado.csv","w", newline="") as archivo2:
        ...
        for linea in archivo:
            if contador_salto > 1:
                ...
                cod_telelink = linea_parseada[0]                            # codigo TLK
                ...
                linea_nueva= [cod_telelink,nro_equipo,tipo_equipo,nro_nodo,slot,puerto, ont, estado, desc_estado,fibra_primaria,par_fibra, indicador_empresarial, indicador_voz, indicador_datos, indicador_RBS] 
                #print (linea_nueva)
                #ESCRIBO EL ARCHIVO 
                
                #sql_list = str(tuple([key for key in linea_nueva])).replace(',)', ')')
                #query ="""
                #    INSERT INTO t_reporte_puertos_telelink( t_cod_telelink, t_nro_equipo, t_tipo_equipo, t_nro_nodo, t_slot, t_puerto, t_ont, t_estado, t_descripcion_estado, t_fibra_primaria, t_par_fibra, t_indicador_empresarial, t_indicador_voz, t_indicador_datos, t_indicador_radiobase) VALUES {sql_list}
                #""".format(sql_list=sql_list)
                #query = query +";\n"
                #archivo2.write (query)
