...
def insert_picos_diarios_semanal():#LISTO
...
def insert_promedio_semanal():#LISTO
...
def insert_picos_semanal():#LISTO
...
def insert_reporte_semanal():#LISTO
...
def insert_resaldo_semanal():#LISTO
...
def insert_reporte_mensual():#TEST
...
def insert_resaldo_mensual():#TEST
