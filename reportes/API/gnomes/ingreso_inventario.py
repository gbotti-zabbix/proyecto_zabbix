...
with open ("datos_central.csv","r") as archivo:
    ...
    for y in lista:
        process = subprocess.run(["./zhostupdater.py","-u","jvignolo","-p","brisingr","-a","http://127.0.0.1/zabbix/api_jsonrpc.php",y[0],"-I","tag={}".format(y[1])],stdout=subprocess.PIPE,universal_newlines=True,)
