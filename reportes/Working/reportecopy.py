...
from direcciones import hojas_PON, hojas_ONT, c300_19p, puertos_uplink, puertos_uplink_h, puertos_uplink_19, puertos_uplink_omitidos_z, puertos_uplink_omitidos_z_19
...
def reportes_xlsx(tipo,periodo):
    ...
    **returns:** Esta funcion no tiene retornos.
    ...
    if tipo == "ONT":
            ...
            if periodo == "mes":
                workbook.save(filename="/home/reportes/test_ont.xlsx")
                os.chmod("/home/reportes/test_ont.xlsx",0o755)
            elif periodo == "semana":
                workbook.save(filename="/home/reportes/test_ont.xlsx")
                os.chmod("/home/reportes/test_ont.xlsx",0o755)
            ...
            if periodo == "mes":
                workbook.save(filename="/home/reportes/test_PON.xlsx")
                os.chmod("/home/reportes/test_PON.xlsx",0o755)
            elif periodo == "semana":
                workbook.save(filename="/home/reportes/test_PON.xlsx")
                os.chmod("/home/reportes/test_PON.xlsx",0o755)
