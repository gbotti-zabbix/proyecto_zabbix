...
def apend_data_PON(workbook,hojas,periodo):
    ...
    for dato in resultado:
        ...
        emp = dato[13]
        rbs = dato[14]
        if (direccion == "RX" and (puerto == "22/1" or puerto == "21/1")) or (direccion == "RX" and tipo == "MA5800" and (puerto == "9/0" or puerto == "10/0")) or (direccion == "TX" and nodo in c300_19p and (puerto == "19/1" or puerto == "20/1")):
        ...
        elif (direccion == "TX" and (puerto == "22/1" or puerto == "21/1")) or (direccion == "TX" and tipo == "MA5800" and (puerto == "9/0" or puerto == "10/0")) or (direccion == "RX" and nodo in c300_19p and (puerto == "19/1" or puerto == "20/1")):
            lista_append = [tipo,nodo,puerto,hora,fecha,pico,(pico*100)/10000,prom_hora_pico,prom_picos_diarios,promedio_hora]
